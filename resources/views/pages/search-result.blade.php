<x-layouts.app title="Hasil Pencarian">
    <div class="flex flex-col gap-16 secondary-padding py-10">
        ...
        <div class="flex flex-col gap-6">
            ...
            {{-- page title --}}
            <x-partials.page-title title="Hasil Pencarian" />
        </div>
        {{-- content --}}
            ...
            <div class="flex-1 flex flex-col gap-4 h-min">
                <div class="flex justify-between items-center py-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <select id="sorting-type" name="sorting-type" class="bg-transparent border-gray-300 text-gray-500 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 border-0 ring-0 focus:border-0 focus:ring-0">

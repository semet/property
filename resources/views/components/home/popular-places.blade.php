<div class="main-padding pt-6 pb-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10">
        @foreach ($locations as $location)
            <a href="{{ route('listing-by-location', $location) }}" data-aos="fade-up" class="flex flex-col md:flex-row items-center rounded-md overflow-hidden hover:shadow-md ring-1 ring-gray-200 cursor-pointer group">
